...
public final class Sorting extends AbstractEnumerator {
	 ...
	 * @ordered
	 */
	public static final Sorting NONE_LITERAL = new Sorting(NONE, "None"); //$NON-NLS-1$
	 ...
	 * @ordered
	 */
	public static final Sorting MANUAL_LITERAL = new Sorting(MANUAL, "Manual"); //$NON-NLS-1$
	 ...
	 * @ordered
	 */
	public static final Sorting AUTOMATIC_LITERAL = new Sorting(AUTOMATIC, "Automatic"); //$NON-NLS-1$
	 ...
	 * @generated
	 */
	public static Sorting get(String name) {
	...
	/**
	 * Returns the '<em><b>Sorting</b></em>' literal with the specified value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	 ...
	 * @generated
	 */
	private Sorting(int value, String name) {
		super(value, name);
	}
