...
/**
 * This is the item provider adapter for a {@link org.eclipse.gmf.runtime.notation.FillStyle} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FillStyleItemProvider
	 ...
	 * @generated
	 */
	public FillStyleItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_FillStyle_type") : //$NON-NLS-1$
			getString("_UI_FillStyle_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(FillStyle.class)) {
