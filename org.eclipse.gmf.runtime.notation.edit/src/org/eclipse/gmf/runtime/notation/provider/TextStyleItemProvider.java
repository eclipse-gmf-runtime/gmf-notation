...
/**
 * This is the item provider adapter for a {@link org.eclipse.gmf.runtime.notation.TextStyle} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TextStyleItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TextStyle_textAlignment_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_TextStyle_textAlignment_feature", "_UI_TextStyle_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 NotationPackage.Literals.TEXT_STYLE__TEXT_ALIGNMENT,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		TextAlignment labelValue = ((TextStyle)object).getTextAlignment();
